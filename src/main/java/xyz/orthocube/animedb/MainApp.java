...
import xyz.orthocube.animedb.view.SeasonEditDialogController;
import xyz.orthocube.animedb.view.SeriesEditDialogController;
import xyz.orthocube.animedb.view.SeriesOverviewController;
...
public class MainApp extends Application {
    ...
    public void showAnimeSeriesOverview() {
        try {
            FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("view/SeriesOverview.fxml"));
    ...
    public boolean showAnimeSeriesEditDialog(Series series) {
        try {
            FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("view/SeriesEditDialog.fxml"));
    ...
    public boolean showAnimeSeasonEditDialog(Season season) {
        try {
            FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("view/SeasonEditDialog.fxml"));
            VBox page = loader.load();
